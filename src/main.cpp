...
void Start()
{
	...
	// Initialize benchmarks
	{
		...
		benchmarks.push_back(std::move(std::make_unique<Benchmark_SimpleBatching>()));
		benchmarks.push_back(std::move(std::make_unique<Benchmark_DynamicIndexing>()));
		benchmarks.push_back(std::move(std::make_unique<Benchmark_StaticIndexing>()));
